...
# specify spline
spl <-bs(observation_data_sensitivity_primary_secondary_aki$time, degree=knots_number)

# aki hosp splines

model_spl4 <- glm(aki_hosp_obs_4 ~ spl,observation_data_sensitivity_primary_secondary_aki,family=quasipoisson)
...
# gastro_model_spl1 <- glm(gastro_hosp_obs_1 ~ spl,observation_data_sensitivity_primary_secondary_aki2,family=quasipoisson)
...
gastro_model_spl4 <- glm(gastro_hosp_obs_4 ~ spl,observation_data_sensitivity_primary_secondary_aki,family=quasipoisson)
...
gastro_gp_model_spl1 <- glm(gastro_gp_obs_1 ~ spl,observation_data_sensitivity_primary_secondary_aki,family=quasipoisson)
...
gastro_gp_model_spl2 <- glm(gastro_gp_obs_2 ~ spl,observation_data_sensitivity_primary_secondary_aki,family=quasipoisson)
